...
BikeSharingSmallAdjusted = BikeSharingSmall[-(1:2500), ]
BikeSharingDFAdjusted = BikeSharingDF[-(1:2500), ]
BikeSharingDFAdjusted_ts = ts(BikeSharingDFAdjusted, start = start(BikeSharingSmallAdjusted$total_cust)[1], frequency = frequency(BikeSharingSmallAdjusted$total_cust))

fit_mlp = mlp(ts(BikeSharingSmallAdjusted$total_cust), reps = 7, comb = "median", xreg = BikeSharingDFAdjusted_ts)
...
```{r}
future_xreg = ts(matrix(nrow = 182, ncol = ncol(BikeSharingDFAdjusted)), start = end(BikeSharingSmallAdjusted$total_cust)[1] + 1/frequency(BikeSharingSmallAdjusted$total_cust), frequency = frequency(BikeSharingSmallAdjusted$total_cust))
fore_mlp = forecast(fit_mlp, h = 182, xreg = future_xreg)
plot(fore_mlp)
```
