...
# MLP Model
```{r}
# Exclude the first 2,000 values from BikeSharingSmall and BikeSharingDF
BikeSharingSmallAdjusted = BikeSharingSmall[-(1:2000), ]
BikeSharingDFAdjusted = BikeSharingDF[-(1:2000), ]

# Now, use BikeSharingSmallAdjusted for the MLP model
...
```{r}
fore_mlp = forecast(fit_mlp, h  = 182, xreg = BikeSharingSmallAdjusted)
```
