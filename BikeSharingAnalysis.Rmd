...
```{r}
#Ensemble
ensemble_182 = (pred_VAR_182$fcst$TotalCust[, 1] + fore_mlp_182$mean) / 3
...
```{r}
#Ensemble
ensemble_7 = (pred_VAR_7$fcst$TotalCust[, 1] + fore_mlp_7$mean) / 3

#Plot
plot(BikeSharing$total_cust, type = "l", xlim = c(2800, nrow(BikeSharing)), ylab = "Total Customers: Actual vs Predicted 1 Week Forecast", main = "1 Week Customer Forecast")
...
```{r}
# Plot the actual vs predicted 'total_cust'
plot(BikeSharing$total_cust, type = "l", main = "Total Customers: Actual vs Predicted 26 Week Forecast", xlab = "Time", ylab = "Total Customers", xlim = c(2800, nrow(BikeSharing)))
lines((nrow(BikeSharing) - 181):nrow(BikeSharing), f, col = "red")
```
