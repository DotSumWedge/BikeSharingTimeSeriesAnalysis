...
#we see slowy dampning acf this means evidence to suggest wandering behavior, also peak at zero for the spectral density adds additional evidence.
...
# Sakava Alternative code with AR(8) S = 7 for 26 weeks
...
```
VARS MODEL Did Better ASE wise for 26 week forecast than the ARMA(1,1) S =7  model.
```{r}
...
#run the code below with function VARselect to find a p = 4 to fit into Var Function
